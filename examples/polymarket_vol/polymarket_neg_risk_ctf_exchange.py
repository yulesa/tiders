...
polymarket_NegRiskCtfExchange_abi_path = Path('/home/yulesa/repos/tiders/examples/polymarket_vol/polymarket_NegRiskCtfExchange.abi.json')
polymarket_NegRiskCtfExchange_abi_json = polymarket_NegRiskCtfExchange_abi_path.read_text()
polymarket_NegRiskCtfExchange_events = {ev.name: {'topic0': ev.topic0, 'signature': ev.signature} for ev in evm_abi_events(polymarket_NegRiskCtfExchange_abi_json)}
polymarket_NegRiskCtfExchange_functions = {fn.name: {'selector': fn.selector, 'signature': fn.signature} for fn in evm_abi_functions(polymarket_NegRiskCtfExchange_abi_json)}
