"""Step that joins EVM transaction fields into other tables."""
...
def execute(
    ...
    """Join EVM transaction columns into the specified tables using a left outer join.
    ...
    Args:
        ...
        config: A :class:`JoinEvmTransactionDataConfig` controlling which
